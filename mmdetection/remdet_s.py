...
# -----data related-----
data_root = '/home/guo/mmdetection/data/VisDrone/'  # Root path of data
# Path of train annotation file
train_ann_file = 'VisDrone2019-DET-train/annotations/train.json'
train_data_prefix = 'VisDrone2019-DET-train/images'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'VisDrone2019-DET-val/annotations/val.json'
val_data_prefix = 'VisDrone2019-DET-val/images'  # Prefix of val image path
